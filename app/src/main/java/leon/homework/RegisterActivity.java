...
public class RegisterActivity extends AppCompatActivity implements View.OnClickListener,Handler.Callback {
    ...
    private TextView tv_message_ver;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv_message_phone = (TextView)findViewById(R.id.tv_message_phone);
        tv_message_pwd = (TextView)findViewById(R.id.tv_message_pwd);
        tv_message_ver = (TextView)findViewById(R.id.tv_message_ver);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.btn_confirm:
                //
                Intent intent2 =new Intent(RegisterActivity.this,CompleteInfo.class);
        ...
        if (result == SMSSDK.RESULT_COMPLETE) {
            if (event == SMSSDK.EVENT_SUBMIT_VERIFICATION_CODE) {
                if(iscreateable2&&iscreateable1){
                    ...
                    Intent intent =new Intent(RegisterActivity.this,CompleteInfo.class);
                    startActivity(intent);
                    finish();
                }
    ...
    public void setMessage(String s){
        switch (s){
            case "456":
                tv_message_phone.setText("请输入手机号");break;
            case "457":
                tv_message_phone.setText("手机号格式错误");break;
            case "466":
                tv_message_ver.setText("请输入验证码");break;
            case "467":
                tv_message_ver.setText("校验验证码请求频繁");break;
            case "468":
                tv_message_ver.setText("验证码错误");break;
            case "601":
                tv_message_phone.setText("短信发送受限");break;
            case "603":
                tv_message_phone.setText("请填写正确的手机号码");break;
            case "604":
                tv_message_phone.setText("当前服务暂不支持此国家");break;
            default:
                tv_message_ver.setText("未知错误，错误代码:"+s);break;
        }
    }
