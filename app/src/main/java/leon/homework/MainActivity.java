...
//                .setHideOnSelect(true)//当选中状态时消失，非选中状态显示
        ;
        //添加选项
        bottom_navigation_bar.addItem(new BottomNavigationItem(R.drawable.people, "步行"))
                .addItem(new BottomNavigationItem(R.drawable.people, "骑行").setBadgeItem(badge))
                .addItem(new BottomNavigationItem(R.drawable.people, "公交").setInactiveIcon(ContextCompat.getDrawable(this,R.drawable.people)))
                .addItem(new BottomNavigationItem(R.drawable.people, "自驾"))
                .addItem(new BottomNavigationItem(R.drawable.people, "火车"))
